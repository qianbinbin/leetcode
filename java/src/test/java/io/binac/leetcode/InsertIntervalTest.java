...
class InsertIntervalTest {
    ...
    private final List<Interval> intervals1 = Arrays.asList(
            new Interval(1, 3),
            new Interval(6, 9)
    );

    private final List<Interval> expected1 = Arrays.asList(
            new Interval(1, 5),
            new Interval(6, 9)
    );

    private final List<Interval> intervals2 = Arrays.asList(
            new Interval(1, 2),
            new Interval(3, 5),
            new Interval(6, 7),
            new Interval(8, 10),
    ...
    private final List<Interval> expected2 = Arrays.asList(
            new Interval(1, 2),
            new Interval(3, 10),
            new Interval(12, 16)
    );
