...
class BinaryTreeLevelOrderTraversalTest {
    ...
    private final BinaryTreeLevelOrderTraversal.Solution2 solution2 = new BinaryTreeLevelOrderTraversal.Solution2();
    ...
    void test2() {
        ...
        assertEquals(expected, solution2.levelOrder(Trees.asTree(3, 9, 20, null, null, 15, 7)));
    }
}