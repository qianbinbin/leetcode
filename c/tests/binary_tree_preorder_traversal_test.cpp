...
TEST(binary_tree_preorder_traversal_test, preorderTraversal_144_1) {
    ...
    int *actual1 = preorderTraversal_144_1(root1, &returnSize1);
    ...
    int *actual2 = preorderTraversal_144_1(root2, &returnSize2);
    ...
    int *actual3 = preorderTraversal_144_1(root3, &returnSize3);
...
TEST(binary_tree_preorder_traversal_test, preorderTraversal_144_2) {
    ...
    int returnSize1 = 0;
    std::vector<int> expected1{1, 2, 3};
    int *actual1 = preorderTraversal_144_2(root1, &returnSize1);
    EXPECT_EQ(expected1, std::vector<int>(actual1, actual1 + returnSize1));
    free(actual1);
    tree_free(root1);
    ...
    int returnSize2 = 0;
    std::vector<int> expected2;
    int *actual2 = preorderTraversal_144_2(root2, &returnSize2);
    EXPECT_EQ(expected2, std::vector<int>(actual2, actual2 + returnSize2));
    free(actual2);
    tree_free(root2);
    ...
    int returnSize3 = 0;
    std::vector<int> expected3{1};
    int *actual3 = preorderTraversal_144_2(root3, &returnSize3);
    EXPECT_EQ(expected3, std::vector<int>(actual3, actual3 + returnSize3));
    free(actual3);
    tree_free(root3);
}
