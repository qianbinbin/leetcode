...
// be 0, while skipA and skipB can be arbitrary values. Explanation: The two
...
#ifndef LEETCODECPP_INTERSECTIONOFTWOLINKEDLISTS_H
#define LEETCODECPP_INTERSECTIONOFTWOLINKEDLISTS_H
...
#endif // LEETCODECPP_INTERSECTIONOFTWOLINKEDLISTS_H
