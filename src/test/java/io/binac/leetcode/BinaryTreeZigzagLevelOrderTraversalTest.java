...
class BinaryTreeZigzagLevelOrderTraversalTest {
    ...
    private final BinaryTreeZigzagLevelOrderTraversal.Solution2 solution2 = new BinaryTreeZigzagLevelOrderTraversal.Solution2();
    ...
    void test2() {
        ...
        assertEquals(expected, solution2.zigzagLevelOrder(Trees.asTree(3, 9, 20, null, null, 15, 7)));
    }
}